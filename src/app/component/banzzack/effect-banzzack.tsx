...
export default function EffectBanzzack({cx, cy, isRead = false}: Props) {
    ...
    return (
        <>
            ...
            <g
                className={'animate-pulse animate-infinite animate-duration-2000 animate-ease-in-out'}
            >
                <ellipse cx={cx} cy={cy} rx={r / 3} ry={r * 3} fill="url(#radial-gradient)"/>
                <ellipse cx={cx} cy={cy} rx={r * 3} ry={r / 3} fill="url(#radial-gradient)"/>
                <g transform={`rotate(-45 ${cx} ${cy})`}>
                    <ellipse cx={cx} cy={cy} rx={r / 3} ry={r * 10} fill="url(#radial-gradient)"/>
                    <ellipse cx={cx} cy={cy} rx={r * 10} ry={r / 3} fill="url(#radial-gradient)"/>
                </g>
            </g>
        </>
    )
