...
export default function TauOriginPath() {
    return (
        <>
            <g id="_11" data-name="11">
                <circle cx="339.99" cy="479.13" r="20" opacity="0"/>
                <circle cx="339.99" cy="479.13" r="5" fill="none" stroke="#fff"/>
            </g>
            <g id="_10" data-name="10">
                <circle cx="339.99" cy="429.91" r="20" opacity="0"/>
                <circle cx="339.99" cy="429.91" r="5" fill="none" stroke="#fff"/>
            </g>
            <g id="_9" data-name="9">
                <circle cx="254.41" cy="412.57" r="20" opacity="0"/>
                <circle cx="254.41" cy="412.57" r="5" fill="none" stroke="#fff"/>
            </g>
            <g id="_8" data-name="8">
                <circle cx="210.78" cy="361.11" r="20" opacity="0"/>
                <circle cx="210.78" cy="361.11" r="5" fill="none" stroke="#fff"/>
            </g>
            <g id="_7" data-name="7">
                <circle cx="147.01" cy="334.26" r="20" opacity="0"/>
                <circle cx="147.01" cy="334.26" r="5" fill="none" stroke="#fff"/>
            </g>
            <g id="_6" data-name="6">
                <circle cx="78.77" cy="304.06" r="20" opacity="0"/>
                <circle cx="78.77" cy="304.06" r="5" fill="none" stroke="#fff"/>
            </g>
            <g id="_5" data-name="5">
                <circle cx="20.01" cy="221.28" r="20" opacity="0"/>
                <circle cx="20.01" cy="221.28" r="5" fill="none" stroke="#fff"/>
            </g>
            <g id="_4" data-name="4">
                <circle cx="260" cy="307.42" r="20" opacity="0"/>
                <circle cx="260" cy="307.42" r="5" fill="none" stroke="#fff"/>
            </g>
            <g id="_3" data-name="3">
                <circle cx="195.12" cy="290.64" r="20" opacity="0"/>
                <circle cx="195.12" cy="290.64" r="5" fill="none" stroke="#fff"/>
            </g>
            <g id="_2" data-name="2">
                <circle cx="183.93" cy="235.82" r="20" opacity="0"/>
                <circle cx="183.93" cy="235.82" r="5" fill="none" stroke="#fff"/>
            </g>
            <g id="_1" data-name="1">
                <circle cx="115.69" cy="160.87" r="20" opacity="0"/>
                <circle cx="115.69" cy="160.87" r="5" fill="none" stroke="#fff"/>
            </g>
            <g id="line" opacity=".6">
