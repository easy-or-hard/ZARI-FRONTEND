...
export default function Cap({setClickedStarNumber, setReadBanzzackVisible, banzzacks}: ConstellationComponentProps) {
    ...
    return (
        <svg onClick={handleClick} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 640">
            ...
            <g id="_8" data-name="8">
                ...
                <circle cx="204.94" cy="471.46" r="5" fill="none" stroke="#fff" />
            </g>
            <g id="_7" data-name="7">
                ...
                <circle cx="137.13" cy="417.44" r="5" fill="none" stroke="#fff" />
            </g>
            <g id="_6" data-name="6">
                ...
                <circle cx="323.67" cy="464.56" r="5" fill="none" stroke="#fff" />
            </g>
            <g id="_5" data-name="5">
                ...
                <circle cx="211.03" cy="315.15" r="5" fill="none" stroke="#fff" />
            </g>
            <g id="_4" data-name="4">
            ...
            <g id="_1" data-name="1">
                ...
                <circle cx="234.02" cy="110.69" r="5" fill="none" stroke="#fff" />
            </g>
            <g id="line">
