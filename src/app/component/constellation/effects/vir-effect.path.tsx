...
export default function VirEffectPath({banzzacks}: ConstellationComponentProps) {
    return (
        <>
            {banzzacks.find(banzzack => banzzack.starNumber === 14) && <EffectBanzzack cx="146.4" cy="553.88"/>}
            {banzzacks.find(banzzack => banzzack.starNumber === 13) && <EffectBanzzack cx="20" cy="518.45"/>}
