...
export default function Ari({setClickedStarNumber, setBanzzackVisible, banzzacks}: ConstellationComponentProps) {
        ...
        <svg onClick={handleClick} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 640">
            ...
            <g id="line">
                <line id="_Path_" data-name="&amp;lt;Path&amp;gt;" x1="145.11" y1="420.88" x2="180.38" y2="526.72"
                      fill="none" opacity=".6" stroke="#fff" stroke-miterlimit="10"/>
